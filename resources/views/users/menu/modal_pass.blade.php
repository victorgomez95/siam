<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-update-{{$employee->id}}">
		...
		if(new_pass.length < 6 ||  new_pass1.length < 6){
			...
			$.ajax({
				...
				success: function (data) {
					$("#modal-update-"+{{$employee->id}}).modal("hide");
					alert(data);
				},
				error:function (data) {
